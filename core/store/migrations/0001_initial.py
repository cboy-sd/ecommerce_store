# Generated by Django 4.0.4 on 2022-12-13 08:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='produc', to='store.category')),
            ...
            options={
                'verbose_name_plural': 'produc',
                'ordering': ('-created',),
            },
            managers=[
                ('produc', django.db.models.manager.Manager()),
            ],
        ),
    ]
